...
jade.debug = [{ lineno: 1, filename: "/www/node/blarney-marionette/client/templates/login.jade" }];
try {
var buf = [];
...
buf.push("<button type=\"submit\" class=\"btn-success btn-elg twitter\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 6, filename: jade.debug[0].filename });
buf.push("Twitter");
jade.debug.shift();
...
buf.push("<a href=\"auth/facebook\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 9, filename: jade.debug[0].filename });
buf.push("<button type=\"submit\" class=\"btn-primary btn-elg twitter\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 9, filename: jade.debug[0].filename });
buf.push("Facebook");
jade.debug.shift();
